...
import { baseXToDecimal, parseLineFromWordlist, readWordlistFromNetwork } from "./utils/wordlist.browser"
...
export { throwNDices, baseXToDecimal, parseLineFromWordlist, readWordlistFromNetwork }