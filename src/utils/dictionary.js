...
var readFile = function (filename) { return __awaiter(_this, void 0, void 0, function () {
    var fileStream, rl, lines, rl_1, rl_1_1, line, e_1_1;
    var e_1, _a;
...
var parseLine = function (line) {
    var _a = line.split('\t'), parsed_indices = _a[0], word = _a[1];
    var indices = Array.from(parsed_indices).map(function (element) { return parseInt(element); });
    return [indices, word];
};
/**
 ...
 */
var loadDicitionaryFromFile = function (filename) {
    if (filename === void 0) { filename = 'src/dictionaries/DW-Espanol-1.txt'; }
    return __awaiter(_this, void 0, void 0, function () {
        var dictionary_txt, dictionary;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, readFile(filename)];
                case 1:
                    dictionary_txt = _a.sent();
                    dictionary = ndarray(Array(7776).fill(""), [6, 6, 6, 6, 6]);
                    dictionary_txt.forEach(function (line) {
                        var _a = parseLine(line), indices = _a[0], word = _a[1];
